...
!!!          113 PRINT *, "fE is: ", fE
        ...
        if ((t .le. age_gym_ang_beg) .AND. (t .gt. age_gym_ang_end)) then
          !!fE = (1.0-GYM)*((age_gym_ang_beg-t)/(age_gym_ang_beg-age_gym_ang_end))+GYM
          fE = (1.0-GYM)*((age_gym_ang_beg-t)/(age_gym_ang_beg-age_gym_ang_end))+GYM
        end if
...
END SUBROUTINE run_geocarb_supp
