...
filename.covarout <- paste('../output/lhs_cret_covar_',data_appen,'_out',prcout_threshold*100,'_',appen,'.RData',sep='')
filename.paramout <- paste('../output/lhs_cret_param_',data_appen,'_out',prcout_threshold*100,'_',appen,'.RData',sep='')
